...
matching_plugins = [plugin for plugin in plugins if plugin.get("name") == "superpowers-brain"]
assert_equal(len(matching_plugins), 1, "superpowers-brain plugin entry count")
