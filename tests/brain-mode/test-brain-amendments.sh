...
assert_file_contains "$requesting_review" 'Substitute the plan path in `PLAN_OR_REQUIREMENTS` accordingly.' "Review skill notes Brain path substitution for its example"
