...
Added explicit priority ordering to using-superpowers-brain:
...
The underlying skills (`superpowers-brain:brainstorming`, `superpowers-brain:executing-plans`, `superpowers-brain:writing-plans`) remain available for Claude to invoke autonomously. This change prevents confusion when Claude would invoke a command that just redirects to a skill anyway.
...
- Updated slash commands to use fully qualified skill names (e.g., `superpowers-brain:brainstorming`)
...
- Namespaced skills: `superpowers-brain:skill-name` for superpowers skills, `skill-name` for personal
...
- Added `superpowers-brain:code-reviewer` agent to plugin's `agents/` directory
- Agent provides systematic code review against plans and coding standards
- Previously required users to have personal agent configuration
- All skill references updated to use namespaced `superpowers-brain:code-reviewer`
- Fixes #55

### Files Changed
- New: `agents/code-reviewer.md` - Agent definition with review checklist and output format
- Updated: `skills/requesting-code-review/SKILL.md` - References to `superpowers-brain:code-reviewer`
- Updated: `skills/subagent-driven-development/SKILL.md` - References to `superpowers-brain:code-reviewer`
...
- All internal skill references now use `superpowers-brain:` namespace prefix
- Updated format: `superpowers-brain:test-driven-development` (previously just `test-driven-development`)
...
- **Fixed command syntax in README** (#44) - Updated all command references to use correct namespaced syntax (`/superpowers-brain:brainstorm` instead of `/brainstorm`). Plugin-provided commands are automatically namespaced by Claude Code to avoid conflicts between plugins.
