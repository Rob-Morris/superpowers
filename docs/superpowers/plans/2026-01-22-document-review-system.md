...
> **For agentic workers:** REQUIRED: Use superpowers-brain:subagent-driven-development (if subagents available) or superpowers-brain:executing-plans to implement this plan.
...
```markdown
> **For agentic workers:** REQUIRED: Use superpowers-brain:subagent-driven-development (if subagents available) or superpowers-brain:executing-plans to implement this plan. Tasks and steps use checkbox (`- [ ]`) syntax for tracking.
```
