...
> **For agentic workers:** REQUIRED: Use superpowers-brain:subagent-driven-development (if subagents available) or superpowers-brain:executing-plans to implement this plan. Steps use checkbox (`- [ ]`) syntax for tracking.
